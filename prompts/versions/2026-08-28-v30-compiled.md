# Current prompt policy: 2026-08-28-v30
...
Answered requests end with the answer instead of an appended invitation.
The `ASK` value means no source was selected; it does not force the model to
ask a question after ordinary conversation it has already answered.
Identity questions receive one short model-authored sentence and stop there.
