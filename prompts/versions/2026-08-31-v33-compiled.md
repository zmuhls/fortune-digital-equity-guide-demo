# Current prompt policy: 2026-08-31-v33

Behavior release: `digital-equity-conversation-grounding`

This release keeps the v32 evidence and concision rules, retains eight complete
exchanges, and removes a response-contract failure exposed by live recall QA.
Conversation-only replies remain model-authored and may use the retained safe
history without inventing a site source or turning participant words into
Digital Equity claims.
...
The privacy hold remains pre-model and requires an actual disclosed
...
source; unsourced conversation replies reject hidden-instruction language and
raw links and must come from the retained safe conversation when structured
source selection is absent. Model prose is not subjected to a personal-
information or site-grounding classifier. There is no canned factual answer,
lexical intent classifier, or silent response truncation.
...
The compiled prompt is 594 words, down from 678 words in v31.
