# Current prompt policy: 2026-09-22-v36

Display version: **v1.36**.

## Change log

Restore eight exchanges; remove lexical rejection of conversational model responses. Reserve rephrasing for abuse, trolling, instruction attacks, and personal identifiers. Ordinary ambiguity gets a specific question. Team instructions saved in Prompts apply to subsequent messages automatically, with revision provenance; existing drafts stay inactive until explicitly saved. Source grounding and privacy remain fixed. No repair or second generation.
