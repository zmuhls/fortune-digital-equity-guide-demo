(() => {
  ...
  const previewPromptLab = {
    ...
    shared: true,
    deployed: {
      version: "2026-08-26-v24",
      behavior_release: "digital-equity-current-calendar",
      editable: false,
    },
    compiled_prompt: [
    ...
    editable_modules: [
      ...
      { key: "clarification", label: "Clarification style", current_variant: "open_conversation_or_blocking_ambiguity", current_value: "When candidate records are empty, pick ASK and respond naturally to the participant without adding claims about Digital Equity services. When records exist, pick ASK only if ambiguity blocks a useful evidence-backed answer. Keep any follow-up brief and responsive to the participant's words.", maximum_length: 500 },
