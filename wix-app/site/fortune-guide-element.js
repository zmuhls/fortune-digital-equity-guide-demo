        ...
        <style>
          ...
          *, *::before, *::after { box-sizing: border-box; }
          ...
          .guide-rays > span {
            ...
            animation: guide-ray-intro .9s cubic-bezier(.22, .74, .28, 1) calc(5s + var(--ray-stagger)) 1 both;
          }
          ...
          @keyframes guide-ray-intro {
            0%, 100% { opacity: 0; transform: rotate(var(--ray-rotation)) scaleX(.05); }
            30% { opacity: .92; transform: rotate(var(--ray-rotation)) scaleX(1); }
            68% { opacity: .62; transform: rotate(var(--ray-rotation)) scaleX(.9); }
          }
          @keyframes guide-ray-interaction {
            0%, 100% { opacity: 0; transform: rotate(var(--ray-rotation)) scaleX(.05); }
            35% { opacity: 1; transform: rotate(var(--ray-rotation)) scaleX(1); }
